-- Applicant Feedback Management System Database Schema
-- Extension to existing Grephene database
-- Date: November 11, 2025

USE Grephene;
GO

-- Templates Table (User Story 4, 13, 14)
...
-- Sections Table (User Story 8, 13, 14)
...
-- Template-Section Links (User Story 14)
...
-- Feedback Paragraphs Table (User Story 12)
...
-- Applicants Table (User Story 3, 5)
...
-- Feedback Sessions Table (User Story 4, 5, 7, 10)
...
-- Feedback Responses Table (User Story 7, 8, 11)
...
-- Completed Feedbacks Table (User Story 11 - PDF storage)
...
BEGIN
    CREATE TABLE CompletedFeedbacks (
        ...
        TemplateName NVARCHAR(200) NOT NULL,
        FeedbackData NVARCHAR(MAX) NOT NULL, -- JSON format
...
-- Health Information Table (User Story 15)
...
BEGIN
    ...
    -- Insert Sample Feedback Paragraphs
