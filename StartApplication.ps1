# Graphene Sensore Application Startup Script
# This script checks prerequisites, sets up the database, and launches the application
...
function Initialize-Database {
    ...
    try {
        ...
        if ($LASTEXITCODE -eq 0) {
            ...
            return $true  # Continue anyway as app has EnsureCreated
        }
    }
    catch {
